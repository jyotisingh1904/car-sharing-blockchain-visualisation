...
class Block:
    ...
    def __init__(self, index, transactions, timestamp, previous_hash, nonce=0):
        ...
        self.nonce = nonce      #Used for the Proof of Work algorithm (default is 0).

    def compute_hash(self):
        """
        A function that Returns a random string as a placeholder for the block's hash. 
        In a real blockchain, you'd use a cryptographic hash like SHA-256.
        """
    ...
    def random_string(self, starts_with='00', stringLength=8):
        """
        Generates a random string of lowercase letters for demonstration purposes,
        prefixed with '00' to mimic the difficulty condition.
        """
...
class Blockchain:
    ...
    def __init__(self):
        ...
        self.chain = []
        self.create_genesis_block()     #creates the first block in the blockchain.
